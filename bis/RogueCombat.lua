...
local function loadBis ()
    ...
    LootAlert:AddItem(spec3, "77188", "Main Hand", "Alt") -- No'Kaled, the Elements of Death
    ...
    LootAlert:AddItem(spec3, "78481", "Main Hand", "Alt") -- No'Kaled, the Elements of Death
    LootAlert:AddItem(spec3, "73439", "Main Hand", "Alt") -- Cataclysmic Gladiator's Quickblade
    LootAlert:AddItem(spec3, "78371", "Main Hand", "Alt") -- Hand of Morchok
    LootAlert:AddItem(spec3, "77223", "Main Hand", "Alt") -- Morningstar of Heroic Will
    LootAlert:AddItem(spec3, "77193", "Main Hand", "Alt") -- Souldrinker
    LootAlert:AddItem(spec3, "78878", "Main Hand", "Alt") -- Spine of the Thousand Cuts
    LootAlert:AddItem(spec3, "73472", "Main Hand", "Alt") -- Cataclysmic Gladiator's Quickblade
