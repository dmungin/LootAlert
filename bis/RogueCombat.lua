...
local function loadBis ()
    ...
    local spec2 = LootAlert:RegisterSpec("Rogue", "Combat", "2")
    local spec3 = LootAlert:RegisterSpec("Rogue", "Combat", "3")
    local spec4 = LootAlert:RegisterSpec("Rogue", "Combat", "4")
    local spec5 = LootAlert:RegisterSpec("Rogue", "Combat", "5")
    ...
    LootAlert:AddItem(spec0, "47709", "Shoulder", "BIS") --Duskstalker Pauldrons
    LootAlert:AddItem(spec0, "47708", "Shoulder", "BIS") --Duskstalker Shoulderpads
    ...
    LootAlert:AddItem(spec0, "47314", "Main Hand", "BIS") --Hellscream Slicer
    LootAlert:AddItem(spec0, "47148", "Main Hand", "BIS") --Stormpike Cleaver
    LootAlert:AddItem(spec0, "46036", "Off Hand", "BIS") --Void Sabre
    ...
    LootAlert:AddItem(spec1, "40496", "Hands", "Alt") --Valorous Bonescythe Gauntlets
    ...
    LootAlert:AddItem(spec1, "40383", "Main Hand", "BIS") --Calamity's Grasp
    LootAlert:AddItem(spec1, "39416", "Main Hand", "Alt") --Kel'Thuzad's Reach
    LootAlert:AddItem(spec1, "40407", "Main Hand", "Alt") --Silent Crusader
    LootAlert:AddItem(spec1, "42208", "Main Hand", "Alt") --Deadly Gladiator's Cleaver
    LootAlert:AddItem(spec1, "42285", "Main Hand", "Alt") --Deadly Gladiator's Slicer
    LootAlert:AddItem(spec1, "39291", "Main Hand", "Alt") --Torment of the Banished
    LootAlert:AddItem(spec1, "43611", "Main Hand", "Alt") --Krol Cleaver
    LootAlert:AddItem(spec1, "39714", "Off Hand", "BIS") --Webbed Death
    LootAlert:AddItem(spec1, "37856", "Off Hand", "Alt") --Librarian's Paper Cutter
    LootAlert:AddItem(spec1, "42248", "Off Hand", "Alt") --Deadly Gladiator's Shiv
    LootAlert:AddItem(spec1, "40368", "Off Hand", "Alt") --Murder
    LootAlert:AddItem(spec1, "40491", "Off Hand", "Alt") --Hailstorm
    LootAlert:AddItem(spec1, "39427", "Off Hand", "Alt") --Omen of Ruin
    LootAlert:AddItem(spec1, "44311", "Off Hand", "Alt") --Avool's Sword of Jin
    ...
    LootAlert:AddItem(spec2, "46127", "Shoulder", "BIS") --Conqueror's Terrorblade Pauldrons
    ...
    LootAlert:AddItem(spec2, "46124", "Hands", "Alt") --Conqueror's Terrorblade Gauntlets
    ...
    LootAlert:AddItem(spec2, "45947", "Main Hand", "Alt") --Serilas, Blood Blade of Invar One-Arm
    LootAlert:AddItem(spec2, "45957", "Main Hand", "Alt") --Furious Gladiator's Handaxe
    LootAlert:AddItem(spec2, "45960", "Main Hand", "Alt") --Furious Gladiator's Longblade
    LootAlert:AddItem(spec2, "45969", "Main Hand", "Alt") --Furious Gladiator's Grasp
    LootAlert:AddItem(spec2, "45266", "Main Hand", "Alt") --Malice
    LootAlert:AddItem(spec2, "45489", "Main Hand", "Alt") --Insanity's Grip
    LootAlert:AddItem(spec2, "46097", "Main Hand", "Alt") --Caress of Insanity
    LootAlert:AddItem(spec2, "45298", "Main Hand", "Alt") --Razorscale Talon
    LootAlert:AddItem(spec2, "40383", "Main Hand", "Alt") --Calamity's Grasp
    ...
    LootAlert:AddItem(spec2, "42249", "Off Hand", "Alt") --Furious Gladiator's Shiv
    ...
    LootAlert:AddItem(spec3, "47526", "Main Hand", "Alt") --Remorseless
    LootAlert:AddItem(spec3, "47528", "Main Hand", "Alt") --Cudgel of the Damned
    ...
    LootAlert:AddItem(spec3, "47001", "Off Hand", "BIS") --Lionhead Slasher
    LootAlert:AddItem(spec3, "47427", "Off Hand", "BIS") --Blood Fury
    ...
    LootAlert:AddItem(spec3, "46969", "Off Hand", "Alt") --Steel Bladebreaker
    LootAlert:AddItem(spec3, "47416", "Off Hand", "Alt") --Stygian Bladebreaker
    LootAlert:AddItem(spec3, "48438", "Off Hand", "Alt") --Relentless Gladiator's Swiftblade
    LootAlert:AddItem(spec3, "48426", "Off Hand", "Alt") --Relentless Gladiator's Dicer
    ...
    LootAlert:AddItem(spec4, "51250", "Chest", "Alt") --Sanctified Shadowblade Breastplate
    ...
    LootAlert:AddItem(spec4, "51253", "Legs", "Alt") --Sanctified Shadowblade Legplates
    ...
    LootAlert:AddItem(spec4, "48229", "Legs", "Alt") --VanCleef's Legplates of Triumph
    LootAlert:AddItem(spec4, "48236", "Legs", "Alt") --Garona's Legplates of Triumph
    ...
    LootAlert:AddItem(spec4, "54569", "Trinket", "Alt") --Sharpened Twilight Scale
    ...
    LootAlert:AddItem(spec4, "45522", "Trinket", "Alt") --Blood of the Old God
    LootAlert:AddItem(spec4, "47734", "Trinket", "Alt") --Mark of Supremacy
    LootAlert:AddItem(spec4, "50737", "Main Hand", "BIS") --Havoc's Call, Blade of Lordaeron Kings
    LootAlert:AddItem(spec4, "50672", "Main Hand", "Alt") --Bloodvenom Blade
    ...
    LootAlert:AddItem(spec4, "51893", "Main Hand", "Alt") --Gutbuster
    LootAlert:AddItem(spec4, "47526", "Main Hand", "Alt") --Remorseless
    LootAlert:AddItem(spec4, "47528", "Main Hand", "Alt") --Cudgel of the Damned
    LootAlert:AddItem(spec4, "51916", "Main Hand", "Alt") --Frost Giant's Cleaver
    LootAlert:AddItem(spec4, "50412", "Main Hand", "Alt") --Bloodvenom Blade
    LootAlert:AddItem(spec4, "51858", "Main Hand", "Alt") --Soulbreaker
    LootAlert:AddItem(spec4, "47156", "Main Hand", "Alt") --Stormpike Cleaver
    LootAlert:AddItem(spec4, "47475", "Main Hand", "Alt") --Hellscream Slicer
    LootAlert:AddItem(spec4, "50654", "Off Hand", "BIS") --Scourgeborne Waraxe
    ...
    LootAlert:AddItem(spec4, "47001", "Off Hand", "Alt") --Lionhead Slasher
    LootAlert:AddItem(spec4, "47427", "Off Hand", "Alt") --Blood Fury
    LootAlert:AddItem(spec4, "50621", "Off Hand", "Alt") --Lungbreaker
    LootAlert:AddItem(spec4, "50759", "Off Hand", "Alt") --Bone Warden's Splitter
    LootAlert:AddItem(spec4, "51448", "Off Hand", "Alt") --Wrathful Gladiator's Swiftblade
    LootAlert:AddItem(spec4, "51440", "Off Hand", "Alt") --Wrathful Gladiator's Dicer
    LootAlert:AddItem(spec4, "51868", "Off Hand", "Alt") --Flesh-Carving Scalpel
    LootAlert:AddItem(spec4, "46036", "Off Hand", "Alt") --Void Sabre
    LootAlert:AddItem(spec4, "46996", "Off Hand", "Alt") --Lionhead Slasher
    LootAlert:AddItem(spec4, "47266", "Off Hand", "Alt") --Blood Fury
    LootAlert:AddItem(spec4, "45331", "Off Hand", "Alt") --Rune-Etched Nightblade
