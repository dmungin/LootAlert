...
local function loadBis ()
    ...
    local spec5 = LootAlert:RegisterSpec("Warlock", "Destruction", "5")
    ...
    LootAlert:AddItem(spec1, "40421", "Head", "Alt") --Valorous Plagueheart Circlet
    ...
    LootAlert:AddItem(spec1, "40526", "Chest", "BIS") --Gown of the Spell-Weaver
    LootAlert:AddItem(spec1, "40423", "Chest", "Alt") --Valorous Plagueheart Robe
    ...
    LootAlert:AddItem(spec1, "40380", "Hands", "BIS") --Gloves of Grandeur
    ...
    LootAlert:AddItem(spec2, "45258", "Feet", "Alt") --Sandals of Rash Temperament
    ...
    LootAlert:AddItem(spec3, "46137", "Chest", "Alt") --Conqueror's Deathbringer Robe
    ...
    LootAlert:AddItem(spec3, "48410", "Two Hand", "Alt") --Relentless Gladiator's Skirmish Staff
    ...
    LootAlert:AddItem(spec4, "51554", "Head", "Alt") --Cowl of Malefic Repose
    ...
    LootAlert:AddItem(spec4, "47693", "Head", "Alt") --Hood of Fiery Aftermath
    LootAlert:AddItem(spec4, "47692", "Head", "Alt") --Hood of Smoldering Aftermath
    ...
    LootAlert:AddItem(spec4, "51020", "Shoulder", "Alt") --Shoulders of Ruinous Senility
    ...
    LootAlert:AddItem(spec4, "47714", "Shoulder", "Alt") --Pauldrons of Catastrophic Emanation
    LootAlert:AddItem(spec4, "47713", "Shoulder", "Alt") --Mantle of Catastrophic Emanation
    ...
    LootAlert:AddItem(spec4, "50469", "Back", "Alt") --Volde's Cloak of the Night Sky
    ...
    LootAlert:AddItem(spec4, "51790", "Chest", "Alt") --Robes of Azure Downfall
    ...
    LootAlert:AddItem(spec4, "51007", "Wrist", "Alt") --Ether-Soaked Bracers
    ...
    LootAlert:AddItem(spec4, "47797", "Hands", "Alt") --Gul'dan's Gloves of Triumph
    LootAlert:AddItem(spec4, "47788", "Hands", "Alt") --Kel'Thuzad's Gloves of Triumph
    ...
    LootAlert:AddItem(spec4, "51017", "Waist", "Alt") --Cauterized Cord
    ...
    LootAlert:AddItem(spec4, "45488", "Legs", "Alt") --Leggings of the Enslaved Idol
    ...
    LootAlert:AddItem(spec4, "50809", "Neck", "Alt") --Soulcleave Pendant
    ...
    LootAlert:AddItem(spec4, "51405", "Two Hand", "Alt") --Wrathful Gladiator's Skirmish Staff
