...
local function loadBis ()
    ...
    LootAlert:AddItem(spec0, "56267", "Back", "BIS") --Periwinkle Cloak
    ...
    LootAlert:AddItem(spec0, "56311", "Chest", "BIS") --Inquisition Robes
    ...
    LootAlert:AddItem(spec0, "65169", "Ring", "BIS") --Lavishly Jeweled Ring
