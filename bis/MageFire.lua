...
local function loadBis ()
    ...
    local spec2 = LootAlert:RegisterSpec("Mage", "Fire", "2")
    local spec3 = LootAlert:RegisterSpec("Mage", "Fire", "3")
    local spec4 = LootAlert:RegisterSpec("Mage", "Fire", "4")
    local spec5 = LootAlert:RegisterSpec("Mage", "Fire", "5")
    ...
    LootAlert:AddItem(spec1, "40417", "Legs", "Alt") --Valorous Frostfire Leggings
    ...
    LootAlert:AddItem(spec2, "46129", "Head", "BIS") --Conqueror's Kirin Tor Hood
    LootAlert:AddItem(spec2, "45497", "Head", "BIS FFB") --Crown of Luminescence
    ...
    LootAlert:AddItem(spec2, "45618", "Back", "BIS FFB") --Sunglimmer Cloak
    ...
    LootAlert:AddItem(spec2, "45275", "Wrist", "BIS") --Bracers of Unleashed Magic
    ...
    LootAlert:AddItem(spec2, "46133", "Legs", "BIS") --Conqueror's Kirin Tor Leggings
    LootAlert:AddItem(spec2, "45488", "Legs", "BIS FFB") --Leggings of the Enslaved Idol
    ...
    LootAlert:AddItem(spec2, "44658", "Neck", "Alt") --Chain of the Ancient Wyrm
    ...
    LootAlert:AddItem(spec2, "45257", "Ranged/Relic", "BIS") --Quartz Crystal Wand
    LootAlert:AddItem(spec2, "39712", "Ranged/Relic", "BIS") --Gemmed Wand of the Nerubians
    ...
    LootAlert:AddItem(spec3, "47766", "Chest", "BIS") --Sunstrider's Robe of Triumph
    LootAlert:AddItem(spec3, "47759", "Chest", "BIS") --Khadgar's Robe of Triumph
    ...
    LootAlert:AddItem(spec3, "47482", "Feet", "BIS") --Boots of the Icy Floe
    LootAlert:AddItem(spec3, "47205", "Feet", "BIS") --Footpads of the Icy Floe
    ...
    LootAlert:AddItem(spec4, "50629", "Chest", "BIS") --Robe of the Waking Nightmare
    LootAlert:AddItem(spec4, "51283", "Chest", "Alt") --Sanctified Bloodmage Robe
    ...
    LootAlert:AddItem(spec4, "51280", "Hands", "BIS") --Sanctified Bloodmage Gloves
    ...
    LootAlert:AddItem(spec4, "47773", "Hands", "Alt") --Sunstrider's Gauntlets of Conquest
    LootAlert:AddItem(spec4, "47752", "Hands", "Alt") --Khadgar's Gauntlets of Conquest
    ...
    LootAlert:AddItem(spec4, "47261", "Main Hand", "Alt") --Barb of Tarasque
    LootAlert:AddItem(spec4, "46979", "Main Hand", "Alt") --Blade of Tarasque
