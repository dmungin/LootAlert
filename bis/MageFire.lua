...
local function loadBis ()
    ...
    LootAlert:AddItem(spec2, "62357", "Back", "Alt") --Cloak of Ancient Wisdom
    LootAlert:AddItem(spec2, "69606", "Back", "Alt") --Hakkari Loa Drape
    LootAlert:AddItem(spec2, "65212", "Chest", "BIS") --Firelord's Robes
    LootAlert:AddItem(spec2, "60244", "Chest", "Alt") --Firelord's Robes
    LootAlert:AddItem(spec2, "62441", "Chest", "Alt") --Robes of Orsis
