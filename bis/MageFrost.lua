...
local function loadBis ()
    local spec0 = LootAlert:RegisterSpec("Mage", "Frost", "0")
    local spec1 = LootAlert:RegisterSpec("Mage", "Frost", "1")
    local spec2 = LootAlert:RegisterSpec("Mage", "Frost", "2")
    local spec3 = LootAlert:RegisterSpec("Mage", "Frost", "3")
    local spec4 = LootAlert:RegisterSpec("Mage", "Frost", "4")
    local spec5 = LootAlert:RegisterSpec("Mage", "Frost", "5")
    ...
    LootAlert:AddItem(spec0, "47419", "Waist", "BIS") --Belt of the Tenebrous Mist
    ...
    LootAlert:AddItem(spec1, "40432", "Trinket", "Alt") --Illustration of the Dragon Soul
    ...
    LootAlert:AddItem(spec3, "48001", "Ring", "BIS") --Firestorm Band
    LootAlert:AddItem(spec3, "47928", "Ring", "BIS") --Firestorm Ring
