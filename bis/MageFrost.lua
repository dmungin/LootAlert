...
local function loadBis ()
    ...
    LootAlert:AddItem(spec3, "71508", "Head", "Alt") -- Firehawk Hood
    ...
    LootAlert:AddItem(spec3, "71511", "Shoulder", "Alt") -- Firehawk Mantle
    ...
    LootAlert:AddItem(spec3, "71510", "Chest", "Alt") -- Firehawk Robes
    ...
    LootAlert:AddItem(spec3, "71509", "Legs", "Alt") -- Firehawk Leggings
