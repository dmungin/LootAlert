...
local function loadBis ()
    ...
    LootAlert:AddItem(spec1, "63477", "Main Hand", "Alt") --Wicked Dagger
    ...
    LootAlert:AddItem(spec1, "68161", "Off Hand", "Alt") --Krol Decapitator
    ...
    LootAlert:AddItem(spec1, "65058", "Ranged/Relic", "Alt") --Themios the Darkbringer
    ...
    LootAlert:AddItem(spec2, "63477", "Main Hand", "Alt") --Wicked Dagger
    ...
    LootAlert:AddItem(spec2, "68161", "Off Hand", "Alt") --Krol Decapitator
    ...
    LootAlert:AddItem(spec2, "65058", "Ranged/Relic", "Alt") --Themios the Darkbringer
    ...
    LootAlert:AddItem(spec3, "71441", "Main Hand", "BIS") --Feeding Frenzy
    ...
    LootAlert:AddItem(spec3, "71786", "Off Hand", "BIS") --Entrail Disgorger
    ...
    LootAlert:AddItem(spec3, "71670", "Tier Token", "ALT") --Crown of the Fiery Vanquisher
