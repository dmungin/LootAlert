...
local function loadBis ()
    ...
    local spec5 = LootAlert:RegisterSpec("Death Knight", "Frost", "5")
    ...
    LootAlert:AddItem(spec0, "40207", "Ranged/Relic", "BIS") --Sigil of Awareness
    ...
    LootAlert:AddItem(spec1, "40189", "Main Hand/Off Hand", "BIS") --Angry Dread
    LootAlert:AddItem(spec1, "42208", "Main Hand/Off Hand", "Alt") --Deadly Gladiator's Cleaver
    ...
    LootAlert:AddItem(spec2, "46115", "Head", "BIS") --Conqueror's Darkruned Helmet
    ...
    LootAlert:AddItem(spec2, "46113", "Hands", "BIS") --Conqueror's Darkruned Gauntlets
    ...
    LootAlert:AddItem(spec2, "46040", "Neck", "Alt") --Strength of the Heavens
    ...
    LootAlert:AddItem(spec2, "45250", "Ring", "Alt") --Crazed Construct Ring
    ...
    LootAlert:AddItem(spec2, "45957", "Main Hand/Off Hand", "Alt") --Furious Gladiator's Handaxe
    LootAlert:AddItem(spec2, "45463", "Main Hand/Off Hand", "Alt") --Vulmir, the Northern Tempest
    ...
    LootAlert:AddItem(spec2, "40207", "Ranged/Relic", "BIS") --Sigil of Awareness
    ...
    LootAlert:AddItem(spec3, "48492", "Hands", "Alt") --Koltira's Gauntlets of Triumph
    ...
    LootAlert:AddItem(spec3, "45241", "Waist", "BIS") --Belt of Colossal Rage
    ...
    LootAlert:AddItem(spec3, "48487", "Legs", "BIS") --Thassarian's Legplates of Triumph
    LootAlert:AddItem(spec3, "48494", "Legs", "BIS") --Koltira's Legplates of Triumph
    ...
    LootAlert:AddItem(spec3, "47465", "Legs", "Alt") --Legplates of Ascension
    LootAlert:AddItem(spec3, "47132", "Legs", "Alt") --Legguards of Ascension
    ...
    LootAlert:AddItem(spec3, "47993", "Ring", "Alt") --Gormok's Band
    LootAlert:AddItem(spec3, "47920", "Ring", "Alt") --Carnivorous Band
    ...
    LootAlert:AddItem(spec3, "47475", "Main Hand/Off Hand", "BIS") --Hellscream Slicer
    LootAlert:AddItem(spec3, "47156", "Main Hand/Off Hand", "BIS") --Stormpike Cleaver
    LootAlert:AddItem(spec3, "47528", "Main Hand/Off Hand", "Alt") --Cudgel of the Damned
    LootAlert:AddItem(spec3, "47526", "Main Hand/Off Hand", "Alt") --Remorseless
    ...
    LootAlert:AddItem(spec3, "40207", "Ranged/Relic", "BIS") --Sigil of Awareness
    ...
    LootAlert:AddItem(spec4, "47548", "Back", "BIS") --Garrosh's Rage
    LootAlert:AddItem(spec4, "47547", "Back", "BIS") --Varian's Furor
    ...
    LootAlert:AddItem(spec4, "51817", "Legs", "BIS") --Legplates of Aetheric Strife
    LootAlert:AddItem(spec4, "51313", "Legs", "BIS") --Sanctified Scourgelord Legplates
    LootAlert:AddItem(spec4, "50624", "Legs", "Alt") --Scourge Reaver's Legplates
    ...
    LootAlert:AddItem(spec4, "50647", "Neck", "Alt") --Ahn'kahar Onyx Neckguard
    LootAlert:AddItem(spec4, "51842", "Neck", "Alt") --Collar of Haughty Disdain
    ...
    LootAlert:AddItem(spec4, "54590", "Trinket", "Alt") --Sharpened Twilight Scale
