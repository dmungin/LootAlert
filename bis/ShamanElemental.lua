...
local function loadBis ()
    ...
    LootAlert:AddItem(spec0, "60315", "Head", "BIS") --Headpiece of the Raging Elements
    ...
    LootAlert:AddItem(spec0, "60317", "Shoulder", "BIS") --Shoulderwraps of the Raging Elements
    ...
    LootAlert:AddItem(spec0, "71291", "Chest", "BIS") --Erupting Volcanic Hauberk
    LootAlert:AddItem(spec0, "60313", "Chest", "Alt") --Hauberk of the Raging Elements
    ...
    LootAlert:AddItem(spec0, "71292", "Hands", "BIS") --Erupting Volcanic Gloves
    LootAlert:AddItem(spec0, "60314", "Hands", "Alt") --Gloves of the Raging Elements
    ...
    LootAlert:AddItem(spec0, "71294", "Legs", "BIS") --Erupting Volcanic Kilt
    LootAlert:AddItem(spec0, "65386", "Legs", "Alt") --Lightning Well Legguards of the Undertow
    LootAlert:AddItem(spec0, "60316", "Legs", "Alt") --Kilt of the Raging Elements
    ...
    LootAlert:AddItem(spec1, "65258", "Shoulder", "Alt") --Shoulderwraps of the Raging Elements
    LootAlert:AddItem(spec1, "65114", "Shoulder", "Alt") --Feludius' Mantle
    LootAlert:AddItem(spec1, "60317", "Shoulder", "Alt") --Shoulderwraps of the Raging Elements
    ...
    LootAlert:AddItem(spec2, "65256", "Head", "BIS") --Headpiece of the Raging Elements
    LootAlert:AddItem(spec2, "65136", "Head", "Alt") --Helm of the Nether Scion
    ...
    LootAlert:AddItem(spec2, "65258", "Shoulder", "Alt") --Shoulderwraps of the Raging Elements
    LootAlert:AddItem(spec2, "65114", "Shoulder", "Alt") --Feludius' Mantle
    LootAlert:AddItem(spec2, "60317", "Shoulder", "Alt") --Shoulderwraps of the Raging Elements
    ...
    LootAlert:AddItem(spec2, "65254", "Chest", "BIS") --Hauberk of the Raging Elements
    ...
    LootAlert:AddItem(spec2, "65255", "Hands", "BIS") --Gloves of the Raging Elements
    ...
    LootAlert:AddItem(spec2, "65257", "Legs", "BIS") --Kilt of the Raging Elements
    ...
    LootAlert:AddItem(spec3, "65256", "Head", "Alt") --Headpiece of the Raging Elements
    ...
    LootAlert:AddItem(spec3, "71556", "Shoulder", "BIS") --Erupting Volcanic Shoulderwraps
    LootAlert:AddItem(spec3, "65248", "Shoulder", "Alt") --Mantle of the Raging Elements
    LootAlert:AddItem(spec3, "65258", "Shoulder", "Alt") --Shoulderwraps of the Raging Elements
    LootAlert:AddItem(spec3, "65114", "Shoulder", "Alt") --Feludius' Mantle
    LootAlert:AddItem(spec3, "60317", "Shoulder", "Alt") --Shoulderwraps of the Raging Elements
    ...
    LootAlert:AddItem(spec3, "71552", "Chest", "BIS") --Erupting Volcanic Hauberk
    LootAlert:AddItem(spec3, "65254", "Chest", "Alt") --Hauberk of the Raging Elements
    ...
    LootAlert:AddItem(spec3, "59310", "Wrist", "Alt") --Chaos Beast Bracers
    LootAlert:AddItem(spec3, "63486", "Wrist", "Alt") --Shackles of the Betrayed
    LootAlert:AddItem(spec3, "56313", "Wrist", "Alt") --Manacles of Pain
    LootAlert:AddItem(spec3, "71553", "Hands", "BIS") --Erupting Volcanic Gloves
    LootAlert:AddItem(spec3, "65255", "Hands", "Alt") --Gloves of the Raging Elements
    ...
    LootAlert:AddItem(spec3, "71555", "Legs", "BIS") --Erupting Volcanic Kilt
    LootAlert:AddItem(spec3, "65257", "Legs", "Alt") --Kilt of the Raging Elements
    ...
    LootAlert:AddItem(spec3, "65110", "Trinket", "Alt") --Heart of Ignacious
