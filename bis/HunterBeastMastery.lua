...
local function loadBis ()
    ...
    local spec2 = LootAlert:RegisterSpec("Hunter", "Beast Mastery", "2")
    local spec3 = LootAlert:RegisterSpec("Hunter", "Beast Mastery", "3")
    local spec4 = LootAlert:RegisterSpec("Hunter", "Beast Mastery", "4")
    local spec5 = LootAlert:RegisterSpec("Hunter", "Beast Mastery", "5")
    ...
    LootAlert:AddItem(spec1, "40505", "Head", "BIS") --Valorous Cryptstalker Headpiece
    LootAlert:AddItem(spec1, "40543", "Head", "Alt") --Blue Aspect Helm
    LootAlert:AddItem(spec1, "40344", "Head", "Alt") --Helm of the Grave
    LootAlert:AddItem(spec1, "42551", "Head", "Alt") --Truesight Ice Blinders
    LootAlert:AddItem(spec1, "37188", "Head", "Alt") --Plunderer's Helmet
    LootAlert:AddItem(spec1, "34333", "Head", "Alt") --Coif of Alleria
    LootAlert:AddItem(spec1, "37726", "Head", "Alt") --King Dred's Helm
    LootAlert:AddItem(spec1, "37636", "Head", "Alt") --Helm of Cheated Fate
    LootAlert:AddItem(spec1, "43403", "Head", "Alt") --Shroud of Darkness
    ...
    LootAlert:AddItem(spec1, "43406", "Back", "Alt") --Cloak of the Gushing Wound
    LootAlert:AddItem(spec1, "36947", "Back", "Alt") --Centrifuge Core Cloak
    ...
    LootAlert:AddItem(spec1, "40503", "Chest", "Alt") --Valorous Cryptstalker Tunic
    LootAlert:AddItem(spec1, "44295", "Chest", "Alt") --Polished Regimental Hauberk
    LootAlert:AddItem(spec1, "37144", "Chest", "Alt") --Hauberk of the Arcane Wraith
    LootAlert:AddItem(spec1, "39579", "Chest", "Alt") --Heroes' Cryptstalker Tunic
    LootAlert:AddItem(spec1, "37800", "Chest", "Alt") --Aviary Guardsman's Hauberk
    LootAlert:AddItem(spec1, "37165", "Chest", "Alt") --Crystal-Infused Tunic
    ...
    LootAlert:AddItem(spec1, "40490", "Wrist", "Alt") --Necromantic Wristguards
    LootAlert:AddItem(spec1, "37656", "Wrist", "Alt") --Raging Construct Bands
    ...
    LootAlert:AddItem(spec1, "37886", "Hands", "Alt") --Handgrips of the Savage Emissary
    LootAlert:AddItem(spec1, "39582", "Hands", "Alt") --Heroes' Cryptstalker Handguards
    LootAlert:AddItem(spec1, "37639", "Hands", "Alt") --Grips of the Beast God
    LootAlert:AddItem(spec1, "37614", "Hands", "Alt") --Gauntlets of the Plundering Geist
    ...
    LootAlert:AddItem(spec1, "37648", "Waist", "Alt") --Belt of Tasseled Lanterns
    ...
    LootAlert:AddItem(spec1, "37845", "Waist", "Alt") --Cord of Swirling Winds
    ...
    LootAlert:AddItem(spec1, "43458", "Legs", "Alt") --Giantmaim Legguards
    LootAlert:AddItem(spec1, "37221", "Legs", "Alt") --Hollowed Mandible Legplates
    ...
    LootAlert:AddItem(spec1, "44182", "Feet", "Alt") --Boots of Twinkling Stars
    LootAlert:AddItem(spec1, "43312", "Feet", "Alt") --Gorloc Muddy Footwraps
    ...
    LootAlert:AddItem(spec1, "42645", "Neck", "Alt") --Titanium Impact Choker
    LootAlert:AddItem(spec1, "37096", "Neck", "Alt") --Necklace of the Chrono-Lord
    ...
    LootAlert:AddItem(spec1, "37624", "Ring", "Alt") --Stained-Glass Shard Ring
    LootAlert:AddItem(spec1, "36979", "Ring", "Alt") --Bjarngrim Family Signet
    ...
    LootAlert:AddItem(spec1, "44193", "Main Hand", "Alt") --Broken Stalactite
    LootAlert:AddItem(spec1, "44311", "Main Hand", "Alt") --Avool's Sword of Jin
    LootAlert:AddItem(spec1, "44187", "Main Hand", "Alt") --Fang of Truth
    LootAlert:AddItem(spec1, "37181", "Main Hand", "Alt") --Dagger of Betrayal
    ...
    LootAlert:AddItem(spec1, "44249", "Two Hand", "Alt") --Runeblade of Demonstrable Power
    LootAlert:AddItem(spec1, "37848", "Two Hand", "Alt") --Lightning Giant Staff
    LootAlert:AddItem(spec1, "36962", "Two Hand", "Alt") --Wyrmclaw Battleaxe
    LootAlert:AddItem(spec1, "34198", "Two Hand", "Alt") --Stanchion of Primal Instinct
    ...
    LootAlert:AddItem(spec1, "44504", "Ranged/Relic", "Alt") --Nesingwary 4000
    LootAlert:AddItem(spec1, "43284", "Ranged/Relic", "Alt") --Amanitar Skullbow
    LootAlert:AddItem(spec1, "37692", "Ranged/Relic", "Alt") --Pierce's Pistol
    LootAlert:AddItem(spec1, "34334", "Ranged/Relic", "Alt") --Thori'dal, the Stars' Fury
    ...
    LootAlert:AddItem(spec2, "45454", "Wrist", "BIS") --Frost-bound Chain Bracers
    ...
    LootAlert:AddItem(spec2, "45467", "Waist", "BIS") --Belt of the Betrayed
    LootAlert:AddItem(spec2, "46095", "Waist", "Alt") --Soul-Devouring Cinch
    ...
    LootAlert:AddItem(spec2, "45562", "Feet", "BIS") --Boots of Living Scale
    ...
    LootAlert:AddItem(spec3, "48265", "Chest", "Alt") --Windrunner's Tunic of Triumph
    LootAlert:AddItem(spec3, "48264", "Chest", "Alt") --Windrunner's Tunic of Triumph
    ...
    LootAlert:AddItem(spec3, "48007", "Ring", "Alt") --Planestalker Band
    LootAlert:AddItem(spec3, "47934", "Ring", "Alt") --Planestalker Signet
    ...
    LootAlert:AddItem(spec3, "47523", "Ranged/Relic", "Alt") --Fezzik's Autocannon
    LootAlert:AddItem(spec3, "47521", "Ranged/Relic", "Alt") --BRK-1000
