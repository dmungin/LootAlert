...
local function loadBis ()
    ...
    -- Current Phase
    LootAlert:AddItem(spec4, "78690", "Head", "BIS") -- Deep Earth Helm
    LootAlert:AddItem(spec4, "76750", "Head", "BIS") -- Deep Earth Helm
    LootAlert:AddItem(spec4, "77149", "Head", "Alt") -- Helmet of Perpetual Rebirth
    LootAlert:AddItem(spec4, "71492", "Head", "Alt") -- Obsidian Arborweave Helm
    LootAlert:AddItem(spec4, "71411", "Head", "Alt") -- Cowl of the Clicking Menace
    LootAlert:AddItem(spec4, "78785", "Head", "Alt") -- Deep Earth Helm
    LootAlert:AddItem(spec4, "71103", "Head", "Alt") -- Obsidian Arborweave Helm
    LootAlert:AddItem(spec4, "71040", "Head", "Alt") -- Cowl of the Clicking Menace
    LootAlert:AddItem(spec4, "65195", "Head", "Alt") -- Stormrider's Helm
    LootAlert:AddItem(spec4, "65066", "Head", "Alt") -- Helm of the Blind Seer
    LootAlert:AddItem(spec4, "78740", "Shoulder", "BIS") -- Deep Earth Mantle
    LootAlert:AddItem(spec4, "76753", "Shoulder", "BIS") -- Deep Earth Mantle
    LootAlert:AddItem(spec4, "71495", "Shoulder", "Alt") -- Obsidian Arborweave Mantle
    LootAlert:AddItem(spec4, "78835", "Shoulder", "Alt") -- Deep Earth Mantle
    LootAlert:AddItem(spec4, "71450", "Shoulder", "Alt") -- Flickering Shoulderpads
    LootAlert:AddItem(spec4, "71106", "Shoulder", "Alt") -- Obsidian Arborweave Mantle
    LootAlert:AddItem(spec4, "71025", "Shoulder", "Alt") -- Flickering Shoulderpads
    LootAlert:AddItem(spec4, "65078", "Shoulder", "Alt") -- Passive Resistor Spaulders
    LootAlert:AddItem(spec4, "65198", "Shoulder", "Alt") -- Stormrider's Mantle
    ...
    LootAlert:AddItem(spec4, "71229", "Back", "Alt") -- Flowing Flamewrath Cape
    LootAlert:AddItem(spec4, "76151", "Back", "Alt") -- Cloak of Subtle Light
    LootAlert:AddItem(spec4, "70990", "Back", "Alt") -- Wings of Flame
    LootAlert:AddItem(spec4, "65108", "Back", "Alt") -- Drape of the Twins
    LootAlert:AddItem(spec4, "69881", "Back", "Alt") -- Planetary Drape of the Undertow
    LootAlert:AddItem(spec4, "78660", "Chest", "BIS") -- Deep Earth Robes
    LootAlert:AddItem(spec4, "76752", "Chest", "BIS") -- Deep Earth Robes
    LootAlert:AddItem(spec4, "71494", "Chest", "Alt") -- Obsidian Arborweave Tunic
    LootAlert:AddItem(spec4, "71424", "Chest", "Alt") -- Incendic Chestguard
    LootAlert:AddItem(spec4, "77127", "Chest", "Alt") -- Decaying Herbalist's Robes
    LootAlert:AddItem(spec4, "78755", "Chest", "Alt") -- Deep Earth Robes
    LootAlert:AddItem(spec4, "71105", "Chest", "Alt") -- Obsidian Arborweave Tunic
    LootAlert:AddItem(spec4, "71010", "Chest", "Alt") -- Incendic Chestguard
    LootAlert:AddItem(spec4, "65197", "Chest", "Alt") -- Stormrider's Robes
    LootAlert:AddItem(spec4, "65045", "Chest", "Alt") -- Scorched Wormling Vest
    LootAlert:AddItem(spec4, "78372", "Wrist", "BIS") -- Mycosynth Wristguards
    LootAlert:AddItem(spec4, "77261", "Wrist", "BIS") -- Mycosynth Wristguards
    LootAlert:AddItem(spec4, "71995", "Wrist", "Alt") -- Bracers of Flowing Serenity
    LootAlert:AddItem(spec4, "71463", "Wrist", "Alt") -- Glowing Wing Bracers
    LootAlert:AddItem(spec4, "77320", "Wrist", "Alt") -- Luminescent Bracers
    LootAlert:AddItem(spec4, "78384", "Wrist", "Alt") -- Mycosynth Wristguards
    LootAlert:AddItem(spec4, "71341", "Wrist", "Alt") -- Glowing Wing Bracers
    LootAlert:AddItem(spec4, "71262", "Wrist", "Alt") -- Smolderskull Bindings
    LootAlert:AddItem(spec4, "65021", "Wrist", "Alt") -- Manacles of the Sleeping Beast
    LootAlert:AddItem(spec4, "78680", "Hands", "BIS") -- Deep Earth Handwraps
    LootAlert:AddItem(spec4, "77160", "Hands", "BIS") -- Fungus-Born Gloves
    LootAlert:AddItem(spec4, "76749", "Hands", "Alt") -- Deep Earth Handwraps
    LootAlert:AddItem(spec4, "71491", "Hands", "Alt") -- Obsidian Arborweave Handwraps
    LootAlert:AddItem(spec4, "71410", "Hands", "Alt") -- Cindersilk Gloves
    LootAlert:AddItem(spec4, "78775", "Hands", "Alt") -- Deep Earth Handwraps
    LootAlert:AddItem(spec4, "69943", "Hands", "Alt") -- Heavenly Gloves of the Moon
    LootAlert:AddItem(spec4, "71102", "Hands", "Alt") -- Obsidian Arborweave Handwraps
    LootAlert:AddItem(spec4, "71044", "Hands", "Alt") -- Cindersilk Gloves
    LootAlert:AddItem(spec4, "65194", "Hands", "Alt") -- Stormrider's Handwraps
    LootAlert:AddItem(spec4, "65113", "Hands", "Alt") -- Hydrolance Gloves
    LootAlert:AddItem(spec4, "78420", "Waist", "BIS") -- Girdle of the Grotesque
    LootAlert:AddItem(spec4, "77248", "Waist", "BIS") -- Girdle of the Grotesque
    LootAlert:AddItem(spec4, "77181", "Waist", "Alt") -- Belt of Universal Curing
    LootAlert:AddItem(spec4, "78884", "Waist", "Alt") -- Girdle of Fungal Dreams
    LootAlert:AddItem(spec4, "78428", "Waist", "Alt") -- Girdle of the Grotesque
    LootAlert:AddItem(spec4, "71249", "Waist", "Alt") -- Firescar Sash
    LootAlert:AddItem(spec4, "65374", "Waist", "Alt") -- Gale Rouser Belt
    LootAlert:AddItem(spec4, "78710", "Legs", "BIS") -- Deep Earth Legwraps
    LootAlert:AddItem(spec4, "76751", "Legs", "BIS") -- Deep Earth Legwraps
    LootAlert:AddItem(spec4, "71986", "Legs", "Alt") -- Leggings of Nature's Champion
    LootAlert:AddItem(spec4, "71493", "Legs", "Alt") -- Obsidian Arborweave Legwraps
    LootAlert:AddItem(spec4, "71474", "Legs", "Alt") -- Firecat Leggings
    LootAlert:AddItem(spec4, "78805", "Legs", "Alt") -- Deep Earth Legwraps
    LootAlert:AddItem(spec4, "71349", "Legs", "Alt") -- Firecat Leggings
    LootAlert:AddItem(spec4, "65384", "Legs", "Alt") -- Gale Rouser Leggings
    LootAlert:AddItem(spec4, "65201", "Legs", "Alt") -- Stormrider's Leggings
    LootAlert:AddItem(spec4, "78434", "Feet", "BIS") -- Treads of Sordid Screams
    LootAlert:AddItem(spec4, "77172", "Feet", "Alt") -- Boots of Fungoid Growth
    LootAlert:AddItem(spec4, "71436", "Feet", "Alt") -- Phoenix-Down Treads
    LootAlert:AddItem(spec4, "77243", "Feet", "Alt") -- Treads of Sordid Screams
    LootAlert:AddItem(spec4, "60236", "Feet", "Alt") -- Nightmare Rider's Boots
    LootAlert:AddItem(spec4, "69952", "Feet", "Alt") -- Ethereal Footfalls
    LootAlert:AddItem(spec4, "70987", "Feet", "Alt") -- Phoenix-Down Treads
    LootAlert:AddItem(spec4, "78364", "Neck", "BIS") -- Petrified Fungal Heart
    LootAlert:AddItem(spec4, "77262", "Neck", "BIS") -- Petrified Fungal Heart
    ...
    LootAlert:AddItem(spec4, "71348", "Neck", "Alt") -- Flowform Choker
    LootAlert:AddItem(spec4, "71423", "Neck", "Alt") -- Heartstone of Rhyolith
    LootAlert:AddItem(spec4, "71012", "Neck", "Alt") -- Heartstone of Rhyolith
    LootAlert:AddItem(spec4, "71214", "Neck", "Alt") -- Firemind Pendant
    LootAlert:AddItem(spec4, "69882", "Neck", "Alt") -- Planetary Amulet of the Undertow
    LootAlert:AddItem(spec4, "65134", "Neck", "Alt") -- Wyrmbreaker's Amulet
    LootAlert:AddItem(spec4, "65112", "Neck", "Alt") -- Valiona's Medallion
    LootAlert:AddItem(spec4, "78419", "Ring", "BIS") -- Ring of the Riven
    LootAlert:AddItem(spec4, "78491", "Ring", "BIS") -- Signet of Suturing
    LootAlert:AddItem(spec4, "78012", "Ring", "BIS") -- Ring of the Riven
    LootAlert:AddItem(spec4, "77229", "Ring", "BIS") -- Signet of Suturing
    ...
    LootAlert:AddItem(spec4, "71024", "Ring", "Alt") -- Crystal Prison Band
    LootAlert:AddItem(spec4, "71211", "Ring", "Alt") -- Soothing Brimstone Circle
    LootAlert:AddItem(spec4, "65076", "Ring", "Alt") -- Security Measure Alpha
    LootAlert:AddItem(spec4, "65373", "Ring", "Alt") -- Planetary Band of the Undertow
    LootAlert:AddItem(spec4, "65123", "Ring", "Alt") -- Signet of the Fifth Circle
    ...
    LootAlert:AddItem(spec4, "68926", "Trinket", "Alt") -- Jaws of Defeat
    ...
    LootAlert:AddItem(spec4, "78476", "Two-Hand", "BIS") -- Maw of the Dragonlord
    LootAlert:AddItem(spec4, "77196", "Two-Hand", "BIS") -- Maw of the Dragonlord
    LootAlert:AddItem(spec4, "78485", "Two-Hand", "BIS") -- Maw of the Dragonlord
    LootAlert:AddItem(spec4, "78404", "Two-Hand", "Alt") -- Scalpel of Unrelenting Agony
    LootAlert:AddItem(spec4, "78363", "Two-Hand", "Alt") -- Vagaries of Time
    LootAlert:AddItem(spec4, "71615", "Two-Hand", "Alt") -- Ko'gun, Hammer of the Firelord
    LootAlert:AddItem(spec4, "77219", "Two-Hand", "Alt") -- Scalpel of Unrelenting Agony
    LootAlert:AddItem(spec4, "77214", "Two-Hand", "Alt") -- Vagaries of Time
    LootAlert:AddItem(spec4, "71560", "Two-Hand", "Alt") -- Chelley's Sterilized Scalpel
    LootAlert:AddItem(spec4, "71355", "Two-Hand", "Alt") -- Ko'gun, Hammer of the Firelord
    LootAlert:AddItem(spec4, "71359", "Two-Hand", "Alt") -- Chelley's Sterilized Scalpel
    LootAlert:AddItem(spec4, "65017", "Two-Hand", "Alt") -- Andoros, Fist of the Dragon King
    LootAlert:AddItem(spec4, "65041", "Two-Hand", "Alt") -- Incineratus
    LootAlert:AddItem(spec4, "78433", "Main Hand", "BIS") -- Ledger of Revolting Rituals
    LootAlert:AddItem(spec4, "77938", "Main Hand", "BIS") -- Dragonfire Orb
    LootAlert:AddItem(spec4, "77245", "Main Hand", "Alt") -- Ledger of Revolting Rituals
    LootAlert:AddItem(spec4, "71448", "Main Hand", "Alt") -- Goblet of Anger
    LootAlert:AddItem(spec4, "78441", "Main Hand", "Alt") -- Ledger of Revolting Rituals
    LootAlert:AddItem(spec4, "71022", "Main Hand", "Alt") -- Goblet of Anger
    LootAlert:AddItem(spec4, "72878", "Main Hand", "Alt") -- Demonic Skull
    LootAlert:AddItem(spec4, "65111", "Main Hand", "Alt") -- Scepter of Ice
    LootAlert:AddItem(spec4, "70112", "Main Hand", "Alt") -- Globe of Moonlight
    LootAlert:AddItem(spec4, "78451", "Off Hand", "BIS") -- Visage of the Destroyer
    LootAlert:AddItem(spec4, "78418", "Off Hand", "BIS") -- Lightning Rod
    LootAlert:AddItem(spec4, "78477", "Off Hand", "Alt") -- Ti'tahk, the Steps of Time
    LootAlert:AddItem(spec4, "77225", "Off Hand", "Alt") -- Visage of the Destroyer
    LootAlert:AddItem(spec4, "71797", "Off Hand", "Alt") -- Sho'ravon, Greatstaff of Annihilation
    LootAlert:AddItem(spec4, "71774", "Off Hand", "Alt") -- Smoldering Censer of Purity
    LootAlert:AddItem(spec4, "77221", "Off Hand", "Alt") -- Lightning Rod
    LootAlert:AddItem(spec4, "71409", "Off Hand", "Alt") -- Funeral Pyre
    LootAlert:AddItem(spec4, "71798", "Off Hand", "Alt") -- Sho'ravon, Greatstaff of Annihilation
    LootAlert:AddItem(spec4, "71775", "Off Hand", "Alt") -- Smoldering Censer of Purity
    LootAlert:AddItem(spec4, "71039", "Off Hand", "Alt") -- Funeral Pyre
    LootAlert:AddItem(spec4, "59525", "Off Hand", "Alt") -- Chelley's Staff of Dark Mending
    LootAlert:AddItem(spec4, "77083", "Ranged/Relic", "BIS") -- Lightning Spirit in a Bottle
    LootAlert:AddItem(spec4, "71577", "Ranged/Relic", "BIS") -- Singed Plume of Aviana
    ...
    LootAlert:AddItem(spec4, "70111", "Ranged/Relic", "Alt") -- Relic of Elune's Light
    LootAlert:AddItem(spec4, "64672", "Ranged/Relic", "Alt") -- Relic of Norgannon
end
