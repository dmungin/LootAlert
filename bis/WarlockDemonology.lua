...
local function loadBis ()
    ...
    local spec1 = LootAlert:RegisterSpec("Warlock", "Demonology", "1")
    local spec2 = LootAlert:RegisterSpec("Warlock", "Demonology", "2")
    local spec3 = LootAlert:RegisterSpec("Warlock", "Demonology", "3")
    local spec4 = LootAlert:RegisterSpec("Warlock", "Demonology", "4")
    local spec5 = LootAlert:RegisterSpec("Warlock", "Demonology", "5")
    ...
    LootAlert:AddItem(spec1, "37684", "Head", "Alt") --Forgotten Shadow Hood
    LootAlert:AddItem(spec1, "41992", "Head", "Alt") --Deadly Gladiator's Felweave Cowl
    ...
    LootAlert:AddItem(spec1, "42066", "Back", "Alt") --Deadly Gladiator's Cloak of Deliverance
    ...
    LootAlert:AddItem(spec1, "37799", "Back", "Alt") --Reanimator's Cloak
    ...
    LootAlert:AddItem(spec1, "41892", "Wrist", "Alt") --Deadly Gladiator's Cuffs of Salvation
    ...
    LootAlert:AddItem(spec1, "40197", "Hands", "BIS") --Gloves of the Fallen Wizard
    ...
    LootAlert:AddItem(spec1, "37798", "Hands", "Alt") --Overlook Handguards
    LootAlert:AddItem(spec1, "42103", "Hands", "Alt") --Moonshroud Gloves
    LootAlert:AddItem(spec1, "42113", "Hands", "Alt") --Spellweave Gloves
    LootAlert:AddItem(spec1, "40380", "Hands", "Alt") --Gloves of Grandeur
    LootAlert:AddItem(spec1, "34342", "Hands", "Alt") --Handguards of the Dawn
    ...
    LootAlert:AddItem(spec1, "41880", "Waist", "Alt") --Deadly Gladiator's Cord of Salvation
    LootAlert:AddItem(spec1, "44309", "Waist", "Alt") --Sash of Jordan
    ...
    LootAlert:AddItem(spec1, "40376", "Legs", "BIS") --Legwraps of the Defeated Dragon
    ...
    LootAlert:AddItem(spec1, "41884", "Feet", "Alt") --Deadly Gladiator's Treads of Salvation
    ...
    LootAlert:AddItem(spec1, "41879", "Feet", "Alt") --Hateful Gladiator's Slippers of Salvation
    ...
    LootAlert:AddItem(spec1, "42032", "Neck", "Alt") --Deadly Gladiator's Pendant of Deliverance
    ...
    LootAlert:AddItem(spec1, "37732", "Ring", "Alt") --Spectral Seal of the Prophet
    LootAlert:AddItem(spec1, "42114", "Ring", "Alt") --Deadly Gladiator's Band of Ascendancy
    ...
    LootAlert:AddItem(spec1, "49076", "Trinket", "BIS") --Mithril Pocketwatch
    ...
    LootAlert:AddItem(spec1, "39199", "Off Hand", "BIS") --Watchful Eye
    LootAlert:AddItem(spec1, "40192", "Off Hand", "Alt") --Accursed Spine
    LootAlert:AddItem(spec1, "42531", "Off Hand", "Alt") --Deadly Gladiator's Reprieve
    ...
    LootAlert:AddItem(spec1, "42530", "Off Hand", "Alt") --Hateful Gladiator's Reprieve
    LootAlert:AddItem(spec1, "38322", "Off Hand", "Alt") --Iron-bound Tome
    LootAlert:AddItem(spec1, "40698", "Off Hand", "Alt") --Ward of the Violet Citadel
    LootAlert:AddItem(spec1, "42525", "Off Hand", "Alt") --Deadly Gladiator's Endgame
    ...
    LootAlert:AddItem(spec1, "42384", "Two Hand", "Alt") --Deadly Gladiator's Energy Staff
    ...
    LootAlert:AddItem(spec1, "37626", "Ranged/Relic", "Alt") --Wand of Sseratus
    ...
    LootAlert:AddItem(spec2, "46136", "Shoulder", "BIS") --Conqueror's Deathbringer Shoulderpads
    ...
    LootAlert:AddItem(spec2, "45297", "Ring", "BIS") --Shimmering Seal
    ...
    LootAlert:AddItem(spec2, "45148", "Trinket", "BIS") --Living Flame
    ...
    LootAlert:AddItem(spec3, "45186", "Shoulder", "Alt") --Soot-Covered Mantle
    LootAlert:AddItem(spec3, "47554", "Back", "BIS") --Lady Liadrin's Conviction
    LootAlert:AddItem(spec3, "47553", "Back", "BIS") --Bolvar's Devotion
    LootAlert:AddItem(spec3, "47552", "Back", "Alt") --Jaina's Radiance
    LootAlert:AddItem(spec3, "47551", "Back", "Alt") --Aethas' Intensity
    ...
    LootAlert:AddItem(spec3, "47794", "Chest", "BIS") --Gul'dan's Robe of Triumph
    LootAlert:AddItem(spec3, "47791", "Chest", "BIS") --Kel'Thuzad's Robe of Triumph
    ...
    LootAlert:AddItem(spec3, "41894", "Wrist", "Alt") --Relentless Gladiator's Cuffs of Salvation
    ...
    LootAlert:AddItem(spec3, "47795", "Legs", "Alt") --Gul'dan's Leggings of Triumph
    LootAlert:AddItem(spec3, "47790", "Legs", "Alt") --Kel'Thuzad's Leggings of Triumph
    ...
    LootAlert:AddItem(spec3, "46139", "Legs", "Alt") --Conqueror's Deathbringer Leggings
    ...
    LootAlert:AddItem(spec3, "41886", "Feet", "Alt") --Relentless Gladiator's Treads of Salvation
    ...
    LootAlert:AddItem(spec3, "45133", "Neck", "BIS") --Pendant of Fiery Havoc
    LootAlert:AddItem(spec3, "45243", "Neck", "BIS") --Sapphire Amulet of Renewal
    LootAlert:AddItem(spec3, "47468", "Neck", "Alt") --Cry of the Val'kyr
    LootAlert:AddItem(spec3, "47144", "Neck", "Alt") --Wail of the Val'kyr
    ...
    LootAlert:AddItem(spec3, "40255", "Trinket", "BIS") --Dying Curse
    ...
    LootAlert:AddItem(spec3, "49490", "Off Hand", "Alt") --Antediluvian Cornerstone Grimoire
    LootAlert:AddItem(spec3, "47525", "Two Hand", "BIS") --Sufferance
    LootAlert:AddItem(spec3, "47524", "Two Hand", "BIS") --Clemency
    LootAlert:AddItem(spec3, "48412", "Two Hand", "Alt") --Relentless Gladiator's Acute Staff
    ...
    LootAlert:AddItem(spec3, "49185", "Ranged/Relic", "Alt") --Relentless Gladiator's Wand of Alacrity
    ...
    LootAlert:AddItem(spec4, "50449", "Shoulder", "Alt") --Stiffened Corpse Shoulderpads
    ...
    LootAlert:AddItem(spec4, "51233", "Chest", "Alt") --Sanctified Dark Coven Robe
    ...
    LootAlert:AddItem(spec4, "47794", "Chest", "Alt") --Gul'dan's Robe of Triumph
    LootAlert:AddItem(spec4, "47791", "Chest", "Alt") --Kel'Thuzad's Robe of Triumph
    LootAlert:AddItem(spec4, "50418", "Chest", "Alt") --Robe of the Waking Nightmare
    ...
    LootAlert:AddItem(spec4, "47126", "Chest", "Alt") --Skyweaver Robes
    LootAlert:AddItem(spec4, "47301", "Chest", "Alt") --Skyweaver Vestments
    ...
    LootAlert:AddItem(spec4, "50240", "Hands", "Alt") --Dark Coven Gloves
    ...
    LootAlert:AddItem(spec4, "50782", "Hands", "Alt") --Sister's Handshrouds
    ...
    LootAlert:AddItem(spec4, "51232", "Legs", "BIS") --Sanctified Dark Coven Leggings
    ...
    LootAlert:AddItem(spec4, "50242", "Legs", "Alt") --Dark Coven Leggings
    LootAlert:AddItem(spec4, "47478", "Legs", "Alt") --Breeches of the Deepening Void
    LootAlert:AddItem(spec4, "47189", "Legs", "Alt") --Leggings of the Deepening Void
    LootAlert:AddItem(spec4, "47274", "Legs", "Alt") --Pants of the Soothing Touch
    LootAlert:AddItem(spec4, "47051", "Legs", "Alt") --Leggings of the Soothing Touch
    ...
    LootAlert:AddItem(spec4, "49990", "Ring", "Alt") --Ring of Maddening Whispers
    ...
    LootAlert:AddItem(spec4, "40255", "Trinket", "Alt") --Dying Curse
    ...
    LootAlert:AddItem(spec4, "51403", "Two Hand", "Alt") --Wrathful Gladiator's Acute Staff
    LootAlert:AddItem(spec4, "51898", "Two Hand", "Alt") --Mag'hari Chieftain's Staff
    LootAlert:AddItem(spec4, "51401", "Two Hand", "Alt") --Wrathful Gladiator's Combat Staff
    LootAlert:AddItem(spec4, "51887", "Two Hand", "Alt") --Abracadaver
    LootAlert:AddItem(spec4, "51828", "Two Hand", "Alt") --Sister Svalna's Aether Staff
    LootAlert:AddItem(spec4, "50631", "Ranged/Relic", "BIS") --Nightmare Ender
    LootAlert:AddItem(spec4, "50684", "Ranged/Relic", "Alt") --Corpse-Impaling Spike
