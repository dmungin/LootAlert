...
local function loadBis ()
    ...
    -- Current Phase
    LootAlert:AddItem(spec4, "78702", "Head", "BIS") -- Hood of the Faceless Shroud
    LootAlert:AddItem(spec4, "77147", "Head", "Alt") -- Hood of Hidden Flesh
    LootAlert:AddItem(spec4, "76342", "Head", "Alt") -- Hood of the Faceless Shroud
    LootAlert:AddItem(spec4, "71595", "Head", "Alt") -- Balespider's Hood
    LootAlert:AddItem(spec4, "71421", "Head", "Alt") -- Flickering Cowl
    LootAlert:AddItem(spec4, "78797", "Head", "Alt") -- Hood of the Faceless Shroud
    LootAlert:AddItem(spec4, "78749", "Shoulder", "BIS") -- Mantle of the Faceless Shroud
    LootAlert:AddItem(spec4, "78366", "Shoulder", "Alt") -- Mosswrought Shoulderguards
    LootAlert:AddItem(spec4, "77267", "Shoulder", "Alt") -- Mosswrought Shoulderguards
    LootAlert:AddItem(spec4, "76339", "Shoulder", "Alt") -- Mantle of the Faceless Shroud
    LootAlert:AddItem(spec4, "71598", "Shoulder", "Alt") -- Balespider's Mantle
    LootAlert:AddItem(spec4, "78381", "Shoulder", "Alt") -- Mosswrought Shoulderguards
    LootAlert:AddItem(spec4, "71461", "Shoulder", "Alt") -- Mantle of Closed Doors
    LootAlert:AddItem(spec4, "78844", "Shoulder", "Alt") -- Mantle of the Faceless Shroud
    ...
    LootAlert:AddItem(spec4, "77096", "Back", "Alt") -- Woundlicker Cover
    LootAlert:AddItem(spec4, "76160", "Back", "Alt") -- Drapes of the Dragonshrine
    LootAlert:AddItem(spec4, "69881", "Back", "Alt") -- Planetary Drape
    LootAlert:AddItem(spec4, "70990", "Back", "Alt") -- Wings of Flame
    LootAlert:AddItem(spec4, "78730", "Chest", "BIS") -- Robes of the Faceless Shroud
    LootAlert:AddItem(spec4, "76340", "Chest", "Alt") -- Robes of the Faceless Shroud
    LootAlert:AddItem(spec4, "77122", "Chest", "Alt") -- Robes of Searing Shadow
    LootAlert:AddItem(spec4, "78365", "Chest", "Alt") -- Robe of Glowing Stone
    LootAlert:AddItem(spec4, "71597", "Chest", "Alt") -- Balespider's Robes
    LootAlert:AddItem(spec4, "78825", "Chest", "Alt") -- Robes of the Faceless Shroud
    ...
    LootAlert:AddItem(spec4, "71990", "Wrist", "Alt") -- Dreamwraps of the Light
    ...
    LootAlert:AddItem(spec4, "78681", "Hands", "Alt") -- Gloves of the Faceless Shroud
    ...
    LootAlert:AddItem(spec4, "71594", "Hands", "Alt") -- Balespider's Handwraps
    LootAlert:AddItem(spec4, "76343", "Hands", "Alt") -- Gloves of the Faceless Shroud
    LootAlert:AddItem(spec4, "71358", "Hands", "Alt") -- Fingers of Incineration
    LootAlert:AddItem(spec4, "78776", "Hands", "Alt") -- Gloves of the Faceless Shroud
    ...
    LootAlert:AddItem(spec4, "78721", "Legs", "BIS") -- Leggings of the Faceless Shroud
    LootAlert:AddItem(spec4, "71980", "Legs", "Alt") -- Lavaquake Legwraps
    LootAlert:AddItem(spec4, "76341", "Legs", "Alt") -- Leggings of the Faceless Shroud
    LootAlert:AddItem(spec4, "71596", "Legs", "Alt") -- Balespider's Leggings
    LootAlert:AddItem(spec4, "71435", "Legs", "Alt") -- Leggings of Billowing Fire
    LootAlert:AddItem(spec4, "78816", "Legs", "Alt") -- Leggings of the Faceless Shroud
    LootAlert:AddItem(spec4, "71283", "Legs", "Alt") -- Balespider's Leggings
    LootAlert:AddItem(spec4, "72802", "Legs", "Alt") -- Time Traveler's Leggings
    ...
    LootAlert:AddItem(spec4, "69954", "Feet", "Alt") -- Boots of the Black Flame
    ...
    LootAlert:AddItem(spec4, "78364", "Neck", "Alt") -- Petrified Fungal Heart
    LootAlert:AddItem(spec4, "71213", "Neck", "Alt") -- Amulet of Burning Brilliance
    LootAlert:AddItem(spec4, "69882", "Neck", "Alt") -- Planetary Amulet
    ...
    LootAlert:AddItem(spec4, "77228", "Ring", "Alt") -- Infinite Loop
    ...
    LootAlert:AddItem(spec4, "78491", "Ring", "Alt") -- Signet of Suturing
    ...
    LootAlert:AddItem(spec4, "77208", "Trinket", "Alt") -- Cunning of the Cruel
    LootAlert:AddItem(spec4, "77995", "Trinket", "Alt") -- Will of Unbinding
    ...
    LootAlert:AddItem(spec4, "71323", "Off Hand", "Alt") -- Molten Scream
    ...
    LootAlert:AddItem(spec4, "71022", "Off Hand", "Alt") -- Goblet of Anger
