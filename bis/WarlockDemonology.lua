...
local function loadBis ()
    ...
    LootAlert:AddItem(spec0, "61473", "Back", "Alt") --Stonebinder's Cloak
    LootAlert:AddItem(spec0, "56126", "Back", "Alt") --Azureborne Cloak
    LootAlert:AddItem(spec0, "67119", "Back", "Alt") --Thousand Bandage Drape
    LootAlert:AddItem(spec0, "55202", "Back", "Alt") --Periwinkle Cloak
    LootAlert:AddItem(spec0, "56107", "Back", "Alt") --Solar Wind Cloak
    LootAlert:AddItem(spec0, "67133", "Chest", "BIS") --Dizze's Whirling Robe
    LootAlert:AddItem(spec0, "60251", "Chest", "Alt") --Shadowflame Robes
    ...
    LootAlert:AddItem(spec0, "54475", "Chest", "Alt") --Deathsilk Robe
    LootAlert:AddItem(spec0, "55278", "Chest", "Alt") --Inquisition Robes
    ...
    LootAlert:AddItem(spec0, "63916", "Waist", "Alt") --Belt of Mystical Betrayal
    LootAlert:AddItem(spec0, "63921", "Waist", "Alt") --Truth-Seeker Belt
    ...
    LootAlert:AddItem(spec0, "55993", "Legs", "Alt") --Legwraps of Astral Rain
    LootAlert:AddItem(spec0, "63802", "Legs", "Alt") --Bastion-Clearing Leggings
    LootAlert:AddItem(spec0, "63807", "Legs", "Alt") --Narkrall's Leggings
    ...
    LootAlert:AddItem(spec0, "63711", "Feet", "Alt") --Magma-Proof Sandals
    LootAlert:AddItem(spec0, "56436", "Feet", "Alt") --Hekatic Slippers
    LootAlert:AddItem(spec0, "55817", "Feet", "Alt") --Slippers of the Twilight Prophet
    ...
    LootAlert:AddItem(spec0, "55859", "Ring", "Alt") --Spirit Creeper Ring
    LootAlert:AddItem(spec0, "63761", "Ring", "Alt") --Red Dragonheart Ring
    ...
    LootAlert:AddItem(spec0, "63834", "Off Hand", "Alt") --Skyflight Beacon
    ...
    LootAlert:AddItem(spec0, "56137", "Two Hand", "Alt") --Staff of Siphoned Essences
    LootAlert:AddItem(spec0, "61403", "Two Hand", "Alt") --Spire of Defiance
    ...
    LootAlert:AddItem(spec0, "55267", "Ranged/Relic", "Alt") --Corla's Baton
    ...
    LootAlert:AddItem(spec1, "65019", "Chest", "BIS") --Shadowblaze Robes
    ...
    LootAlert:AddItem(spec1, "65259", "Hands", "BIS") --Shadowflame Handwraps
    ...
    LootAlert:AddItem(spec1, "63441", "Neck", "Alt") --Pendant of the Keep
    ...
    LootAlert:AddItem(spec1, "65169", "Ring", "Alt") --Lavishly Jeweled Ring
    LootAlert:AddItem(spec1, "62415", "Ring", "Alt") --Band of Lamentation
    LootAlert:AddItem(spec1, "62427", "Ring", "Alt") --Band of Singing Grass
    LootAlert:AddItem(spec1, "56276", "Ring", "Alt") --Anthia's Ring
