...
local function loadBis ()
    ...
    LootAlert:AddItem(spec3, "78366", "Shoulder", "BIS") -- Mosswrought Shoulderguards
    LootAlert:AddItem(spec3, "78747", "Shoulder", "Alt") -- Mantle of Dying Light
    ...
    LootAlert:AddItem(spec3, "78365", "Chest", "BIS") -- Robe of Glowing Stone
    LootAlert:AddItem(spec3, "78728", "Chest", "Alt") -- Robes of Dying Light
    ...
    LootAlert:AddItem(spec3, "71086", "Two-Hand", "Alt") -- Dragonwrath, Tarecgosa's Rest
