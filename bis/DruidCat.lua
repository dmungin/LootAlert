...
local function loadBis ()
    ...
    LootAlert:AddItem(spec0, "63449", "Shoulder", "BIS") --Thieving Spaulders
    ...
    LootAlert:AddItem(spec0, "55066", "Two Hand", "BIS") --Elementium Poleaxe
    LootAlert:AddItem(spec0, "56343", "Two Hand", "Alt") --Darkling Staff
    LootAlert:AddItem(spec0, "56382", "Two Hand", "Alt") --Seliza's Spear
