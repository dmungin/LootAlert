...
local function loadBis ()
    ...
    LootAlert:AddItem(spec4, "78789", "Head", "BIS") -- Deep Earth Headpiece
    ...
    LootAlert:AddItem(spec4, "77161", "Hands", "BIS") -- Lightfinger Handwraps
    ...
    LootAlert:AddItem(spec4, "65026", "Trinket", "BIS") -- Prestor's Talisman of Machination
    LootAlert:AddItem(spec4, "58181", "Trinket", "Alt") -- Fluid Death
    LootAlert:AddItem(spec4, "69001", "Trinket", "Alt") -- Ancient Petrified Seed
    LootAlert:AddItem(spec4, "59520", "Trinket", "BIS") -- Unheeded Warning
    LootAlert:AddItem(spec4, "56328", "Trinket", "BIS") -- Key to the Endless Chamber
    ...
    LootAlert:AddItem(spec4, "64671", "Ranged/Relic", "BIS") -- Relic of Golganneth
end
