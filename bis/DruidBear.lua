...
local function loadBis ()
    ...
    LootAlert:AddItem(spec3, "77148", "Head", "BIS") -- Nocturnal Gaze
    ...
    LootAlert:AddItem(spec3, "78789", "Head", "Alt") -- Deep Earth Headpiece
    ...
    LootAlert:AddItem(spec3, "73615", "Hands", "BIS") -- Cataclysmic Gladiator's Dragonhide Gloves
    ...
    LootAlert:AddItem(spec3, "73531", "Feet", "BIS") -- Cataclysmic Gladiator's Boots of Cruelty
    ...
    LootAlert:AddItem(spec3, "73645", "Neck", "BIS") -- Cataclysmic Gladiator's Necklace of Proficiency
    ...
    LootAlert:AddItem(spec3, "77990", "Trinket", "Alt") -- Soulshifter Vortex
    LootAlert:AddItem(spec3, "65109", "Trinket", "BIS") -- Vial of Stolen Memories
    LootAlert:AddItem(spec3, "68915", "Trinket", "Alt") -- Scales of Life
    LootAlert:AddItem(spec3, "65048", "Trinket", "BIS") -- Symbiotic Worm
    ...
    LootAlert:AddItem(spec3, "73642", "Ranged/Relic", "Alt") -- Cataclysmic Gladiator's Relic of Triumph
    LootAlert:AddItem(spec3, "71567", "Ranged/Relic", "Alt") -- Covenant of the Flame
