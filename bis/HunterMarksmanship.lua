...
local function loadBis ()
    ...
    local spec1 = LootAlert:RegisterSpec("Hunter", "Marksmanship", "1")
    local spec2 = LootAlert:RegisterSpec("Hunter", "Marksmanship", "2")
    local spec3 = LootAlert:RegisterSpec("Hunter", "Marksmanship", "3")
    local spec4 = LootAlert:RegisterSpec("Hunter", "Marksmanship", "4")
    local spec5 = LootAlert:RegisterSpec("Hunter", "Marksmanship", "5")
    ...
    LootAlert:AddItem(spec1, "40504", "Hands", "Alt") --Valorous Cryptstalker Handguards
    ...
    LootAlert:AddItem(spec1, "39762", "Waist", "Alt") --Torn Web Wrapping
    LootAlert:AddItem(spec1, "39379", "Waist", "Alt") --Spectral Rider's Girdle
    LootAlert:AddItem(spec1, "37407", "Waist", "Alt") --Sovereign's Belt
    LootAlert:AddItem(spec1, "40506", "Legs", "BIS") --Valorous Cryptstalker Legguards
